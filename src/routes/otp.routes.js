...
const { validateResendOtp, validateVerifyOtp, validateResendOtpPrivate, validateVerifyOtpPrivate } = require("../validators/otp.validator");
const { generalLimiter } = require("../middlewares/rateLimit.middleware");

// Public routes — email from body
...
// Protected routes — email from token
